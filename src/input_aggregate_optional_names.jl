...
const state_names_ess=["A","RB","σ","qΠ","qΠlag"]

# Note: when concatenating with other controls, make sure `profits` stays last element in array.
const control_names_ess=["r","w","K","π","q","N","mcw","Ht","av_tax_rate","T","B","τlev","τprog","GiniW", "GiniC", "GiniX", "GiniI", "sdlgC", "P9010C", "I90share", "I90sharenet","P9010I", "w90share", "P10C", "P50C", "P90C","firm_profits","profits"]
