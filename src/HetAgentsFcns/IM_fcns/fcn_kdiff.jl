...
"""
function Kdiff(K_guess::Float64, n_par::NumericalParameters, m_par::ModelParameters,BKratio)
    ...
    B = BKratio*K_guess # steady state ratio
    K::Float64   = Ksupply(m_par.RB./m_par.π,1.0+r,w*N/n_par.H,profits,B, n_par,m_par)[1]
    diff    = K - K_guess
    return diff
end
